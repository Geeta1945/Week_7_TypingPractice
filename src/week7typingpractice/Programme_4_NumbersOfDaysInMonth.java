 ...
 * This method needs to return the number of days in the month. Be careful about leap yeats they have 29 days in month 2 (February)
 * You should check if the year s a leap year using the method isLeapYear describe above.
 * Example of input/output:
